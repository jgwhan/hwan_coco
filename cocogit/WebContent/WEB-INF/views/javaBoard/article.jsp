	                     ...
	                     <tr>
	                         <td colspan="2">
							      ...
							      <c:if test="${not empty preReadDto }">
								      <a href="<%=cp%>/javaBoard/article.do?${params}&num=${preReadDto.num}">${preReadDto.subject}</a>
							       </c:if>
	                         </td>
	                     </tr>
	                     <tr>
	                         <td colspan="2" style="border-bottom: #d5d5d5 solid 1px;">
							      ...
							      <c:if test="${not empty nextReadDto }">
								      <a href="<%=cp%>/javaBoard/article.do?${params}&num=${nextReadDto.num}">${nextReadDto.subject}</a>
							       </c:if>
	                         </td>
	                     </tr>
	                </tbody>
