...
function searchList() {
	...
	f.action="<%=cp%>/studyBoard/list.do";
	f.submit();
}
</script>
	    ...
	    <div>
	        ...
	        <div style="clear: both;">
	        		<div style="float: left; width: 20%; min-width: 85px;">
	        		    <button style="color: white; background-color: black; border-color: activeborder; color=""" type="button" class="btn btn-default btn-sm wbtn" onclick="javascript:location.href='<%=cp%>/studyBoard/list.do';">새로고침</button>
	        		</div>
	        		...
	        		<div style="float: left; width: 20%; min-width: 85px; text-align: right;">
	        		    <button type="button" class="btn btn-primary btn-sm bbtn" onclick="javascript:location.href='<%=cp%>/studyBoard/created.do';" style="background-color: black; border-color: activeborder;"><span class="glyphicon glyphicon glyphicon-pencil" ></span> 글쓰기</button>
	        		</div>
	        </div>
	    </div>
